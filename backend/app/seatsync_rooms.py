...
# Hackathon Memory DB to track connected seats

# Example: {'12A': 'socket_id_123', '14B': 'socket_id_456'}

active_users = {}

reverse_users = {} # To look up seat by socket_id
 
# HELPER: Safely find the exact partner so we don't broadcast to the whole server!
...
async def handle_request_match(sid, data):
    ...
    # Fake the AI processing time so the UI spinner shows during the demo!
